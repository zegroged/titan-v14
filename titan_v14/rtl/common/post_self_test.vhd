...
--
-- NIST AES-256 Test Vector — Source Traceability:
--   Standard:    FIPS 197 "Advanced Encryption Standard (AES)"
--   Publication: November 26, 2001, National Institute of Standards and Technology
--   Section:     Appendix C.3 — "AES-256 (Nk=8, Nr=14)"
--   URL:         https://csrc.nist.gov/publications/detail/fips/197/final
--   Cross-ref:   NIST SP 800-38A, Section F.5.5 (CTR mode, same key)
--
...
--
-- Verification: KAT result is compared against KAT_EXPECTED constant.
-- If mismatch → post_fail = '1' (latched), system boot BLOCKED.
-- Compliant with FIPS 140-3 §4.9 (POST) and AS2 (conditional self-test).
--------------------------------------------------------------------------------
